...
using namespace std; 
///////////
////////Implementations only used in Game
////////////////

//computeDanger implementation
...
//recommendMove implementation - only used in Game
...
//decodeDirection implementations
	...
	for (;;)
	{
		...
		else if (playerMove.size() == 1)
		{
			...
			//if h is selected 
				...
				//replace screen with previous 
				m_arena->display("");

				//does not count as player turn
				continue;
			}
		}
